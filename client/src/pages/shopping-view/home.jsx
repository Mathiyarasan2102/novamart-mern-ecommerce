...
function ShoppingHome() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="relative w-full h-[150px] sm:h-[350px] md:h-[350px] lg:h-[500px] xl:h-[600px] overflow-hidden">
        ...
        <Button
          ...
          className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-white/80 w-6 h-6 sm:w-8 sm:h-8 lg:w-12 lg:h-12"
        >
        ...
        <Button
          ...
          className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-white/80 w-6 h-6 sm:w-8 sm:h-8 lg:w-12 lg:h-12"
        >
